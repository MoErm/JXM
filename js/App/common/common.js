                              ...
                              <div class="pay_form">\
                                <ul>\
                                  <li class="frm_item frm_item_getcode">\
                                    ...
                                    <input type="text" id="inpt_code" maxlength="8 "class="frm_inpt"  placeholder="" style="padding-right:10px;" >\
                                    <span class="code js_code">获取验证码</span></li>\
                                  <li class="frm_item">\
                                    <label for="inpt_pssword">交易密码</label>\
                                    <input type="password" id="inpt_pssword" maxlength="12" class="frm_inpt"  placeholder="" >\
                                  </li>\

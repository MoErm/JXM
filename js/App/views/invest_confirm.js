define(function (require, exports, module) {
    ...
    var Template = require("App/tpl/invest_confirm.tpl");
    var tool = require("App/utils/Tool")
    var payLayer = require("App/common/common")
      ...
      /* active:function(){
        ...
        createOrder: function () {
            ...
            if (surplus <= 0) {
                ...
                var query = this.request.query;
                window.app.goHtml("App_detail?pid="+query.pid)
            }
            //是否是数字
            ...
            header.set({
                ...
                back: {
                    ...
                    callback: function () {
                       ...
                       App.goTo("App_detail?pid="+query.pid)
                    }
                },
                right: null
            });

define(function (require, exports, module) {
    var tpl = '<article class="mod_page page_invest">\
                    <ul class="listing">\
                        <li class="item">\
                            <%=showTag(incomeType,isForNew,investDeadline,saleStartTime,productTag)%><h3 class="item_title"><%if(productName.length <=20){%><%=productName%><%}else{%><%=productName.substr(0,20)%>...<%}%></h3>\

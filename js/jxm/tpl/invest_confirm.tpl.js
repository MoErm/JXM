	    ...
	    <ul class="invest_list invest_confim">\
	      <li class="item invest_regular">\
	        ...
	        <div class="ttl_buy_one_m">\
				<div class="mycard" id="cardSelect" data-cardid= "<%=cardInfoId%>">\
				...
				<div class="imoney">\
					...
					<div class="imoney_content">\
						<input type="number" class="imoney_num js_amount" id="imoney_num" placeholder="<%=minInvestAmount_show%>元起投，<%=additionalAmount_show%>元递增"/>\

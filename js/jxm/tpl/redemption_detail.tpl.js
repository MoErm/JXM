	 ...
	 <div id="invest_page">\
       <ul class="invest_list" id="invest_record">\
	    ...
	    <li  class="v_mod item investList">\
	    	...
	    	<span class="redemption_span1">赎回收益率</span><span class="redemption_span2"><%=order.ransomRate%></span><span class="redemption_span3"><%=order.clearingPrincipal%>+<%=order.clearingInterest%></span><br>\

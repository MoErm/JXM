...
define(function (require, exports, module) {
        var confirmCard = require('jxm/tpl/rebind_confirm_card.tpl');
        var tool = require('jxm/utils/Tool');
        var handle = new tool();
        var model = require("jxm/model/model");
        var getBindCardMsg = new model.getBindCardMsg();
        var rebindCheckBindCardMsg = new model.rebindCheckBindCardMsg();
        ...
        module.exports = App.Page.extend({
            ...
            next: function(){
                ...
                App.showLoading();
                rebindCheckBindCardMsg.set({'msgCode' : code});
                rebindCheckBindCardMsg.exec().then(function(data){
                    App.hideLoading();
                    if(data.ret == 0){
                        App.showToast("绑卡成功");

define(function (require, exports, module) {
	...
	var Template = require("jxm/tpl/detail_float.tpl");
	...
	module.exports = App.Page.extend({
		...
		render: function () {
			...
			return getOrderInfo.exec({
				...
				success: function (data){
            		...
            		if(data.ret == 0){
            			self.data = data.data
            			data.data.rightdate = data.data.floatProdInfo.rightConfirmDate.split(" ")[0]
		...
		goPay: function () {
			payLayer.showPayWin(self.data,self.data.floatProdInfo.investAmout,self.data,false)
		},

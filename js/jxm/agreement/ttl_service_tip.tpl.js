    ...
    var tpl ='<article class="ttl_service_tip" id="ttl_service_tip">\
    	<div class="ttl_service_tip_t">\
    		...
    		<ul class="tip_title">\
    			...
    			<li>乙方（转让方）:</li>\
    			<li>住所:</li>\
    			<li>丙方（服务方）:上海展义金融信息服务有限公司</li>\
    			<li>住所:上海市长宁区虹桥路2283号君座别墅11号楼4楼</li>\
    		</ul>\
    	</div>\
    	<div class="ttl_service_tip_m">\
    		...
    		<dl class="tip_list">\
	    		...
	    		<dd>\
					...
					<p>3.2受让方在加薪猫平台上通过其注册的账户签订本协议即视为不可撤销地授权服务方从受让方指定的银行（或合作机构）账户中主动扣收等值于收益权转让价款的款项并支付给转让方。受让方知晓并确认，服务方可直接通过第三方机构提供代收付服务，也可再授权其他方通过指定的第三方提供代收付服务，服务方仅根据前述授权提供代收付服务，无义务对该项代扣代收的时效性和结果承担任何责任，受让方应保证受让方银行（或合作机构）账户中有足额款项且应承担前述代收付的法律后果。 </p>\
    		...
    		<div class="tip_list_info">\
    			<ul class="info_list">\
					<li>受让方：</li>\
					<li>转让方：</li>\
					<li>服务方：上海展义金融信息服务有限公司</li>\
    			</ul>\
